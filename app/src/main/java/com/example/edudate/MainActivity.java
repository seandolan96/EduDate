...
import com.example.edudate.Cards.arrayAdapter;
import com.example.edudate.Cards.cards;
...
public class MainActivity extends AppCompatActivity {
    ...
    private com.example.edudate.Cards.arrayAdapter arrayAdapter;
    private int i;
    ...
    public void getOppSexUsers(){
        usersDb.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                if(dataSnapshot.exists() && !dataSnapshot.child("connections").child("no").hasChild(currentUid) && !dataSnapshot.child("connections").child("yes").hasChild(currentUid) && dataSnapshot.child("sex").getValue().toString().equals(oppUserSex)){
